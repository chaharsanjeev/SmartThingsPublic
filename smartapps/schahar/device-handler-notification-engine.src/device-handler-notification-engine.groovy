/**
 * Get the Event notification from Device handlers and display them to the device through SmartApp 
 *
 * 
 *
 *
...
def subscribeToEvents() {
    ...
    //subscribe(button, "alarmSystemStatus", eventHandler) //tw
